...
diemdanh_button = Button(window, text="ĐIỂM DANH", height=10, width=30, bd=0, bg='#5F9EA0')
...
giaovien_button = Button(window, text="GIẢNG VIÊN", height=10, width=30, bd=0, bg='#5F9EA0')
giaovien_button.place(relx=0.5, rely=0.68, anchor='center')
monhoc_button = Button(window, text="MÔN HỌC", height=10, width=30, bd=0, bg='#5F9EA0')
